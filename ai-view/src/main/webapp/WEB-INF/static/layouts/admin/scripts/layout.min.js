var Layout = function () {
    var e = "layouts/admin/img/", a = "layouts/admin/css/", i = App.getResponsiveBreakpoint("md"), t = [], s = [], o = function () {
        ...
        $(".page-sidebar-menu").on("click", "li > a.nav-toggle, li > a > span.nav-toggle", function (e) {
            ...
            if (!(App.getViewPort().width >= i && !$(".page-sidebar-menu").attr("data-initialized") && $("body").hasClass("page-sidebar-closed") && 1 === a.parent("li").parent(".page-sidebar-menu").size())) {
                ...
                if (!(App.getViewPort().width >= i && 1 === a.parents(".page-sidebar-menu-hover-submenu").size())) {
                    ...
                    var s = a.parent().parent(), n = a, r = $(".page-sidebar-menu"), l = a.next(), d = r.data("auto-scroll"), p = parseInt(r.data("slide-speed")), c = r.data("keep-expanded");
